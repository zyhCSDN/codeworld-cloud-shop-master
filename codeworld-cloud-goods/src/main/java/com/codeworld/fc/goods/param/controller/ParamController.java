...
public class ParamController {
    ...
    @GetMapping("/get-special-param-category-id/{categoryId}")
    @ApiOperation("查询分类下的属性的特有参数")
    public FCResponse<List<ParamResponse>> getSpecialParamByCategoryId(@PathVariable("categoryId") Long categoryId){
