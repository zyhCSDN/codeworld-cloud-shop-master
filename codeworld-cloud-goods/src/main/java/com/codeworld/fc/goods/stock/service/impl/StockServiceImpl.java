...
public class StockServiceImpl implements StockService {
     ...
     */
    @Override
    public FCResponse<Integer> getStockByProductSkuId(Long productSkuId) {
        Integer stock = this.stockMapper.getStockByProductSkuId(productSkuId);
        return FCResponse.dataResponse(HttpFcStatus.DATASUCCESSGET.getCode(), HttpMsg.stock.STOCK_SELECT_SUCCESS.getMsg(), stock);
    }
}
