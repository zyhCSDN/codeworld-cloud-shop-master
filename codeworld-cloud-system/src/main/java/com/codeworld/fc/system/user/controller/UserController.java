...
public class UserController {
    ...
    @GetMapping("/page")
    @ApiOperation("分页获取全部用户")
    public FCResponse<DataResponse<List<UserResponse>>> getAllUser(@ApiParam(value = "用户搜索Request", required = false) UserSearchRequest userSearchRequest) {
        return this.userService.page(userSearchRequest);
    }
    ...
    @ApiOperation("添加用户")
    public FCResponse<Void> addUser(@RequestBody @Validated UserRegisterRequest userRegisterRequest) {
